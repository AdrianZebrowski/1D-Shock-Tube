...
fig1.suptitle("Figure 1: Comparison of FVS and FDS methods, Test 1, $Δx = 0.025$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(1,0.636,0.025)
[rho2,u2,p2,e2,x2] = roe1D(1,1,0.025)
...
fig1.savefig('HW7 Figure 1.png', dpi=300)

##########

### PART 2
fig2, axs1 = plt.subplots(4,figsize=(6,8))
fig2.suptitle("Figure 2: Comparison of FVS and FDS methods, Test 1, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(1,0.636,0.0125)
[rho2,u2,p2,e2,x2] = roe1D(1,1,0.0125)
...
fig2.savefig('HW7 Figure 2.png', dpi=300)
...
for i, dx in enumerate(dx_array):     
    ...
    [rho1,u1,p1,e1,x1] = vanleer1D(1,0.636,dx)
    [rho2,u2,p2,e2,x2] = roe1D(1,1,dx)
...
fig3.suptitle("Figure 3: Comparison of L2 error norms, Test 1",fontsize=10)
...
axs4[3].legend(loc='upper center', bbox_to_anchor=(0.5,-0.35),ncol=5)
axs4[3].set_xlim([9, 1e3])
fig3.subplots_adjust(top=0.95)
fig3.savefig('HW7 Figure 3.png', dpi=300)
...
fig4.suptitle("Figure 4: Comparison of FVS and FDS methods, Test 2, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(2,0.636,0.0125)
[rho2,u2,p2,e2,x2] = roe1D(2,0.9,0.0125)
...
fig4.savefig('HW7 Figure 4.png', dpi=300)
...
fig5.suptitle("Figure 5: Comparison of FVS and FDS methods, Test 3, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(3,0.636,0.0125)
[rho2,u2,p2,e2,x2] = roe1D(3,1,0.0125)
...
fig5.savefig('HW7 Figure 5.png', dpi=300)
...
fig6.suptitle("Figure 6: Comparison of FVS and FDS methods, Test 4, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(4,0.636,0.0125)
[rho2,u2,p2,e2,x2] = roe1D(4,1,0.0125)
...
fig6.savefig('HW7 Figure 6.png', dpi=300)
...
fig7.suptitle("Figure 7: Comparison of FVS and FDS methods, Test 5, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1D(5,0.636,0.0125)
[rho2,u2,p2,e2,x2] = roe1D(5,1,0.0125)
...
fig7.savefig('HW7 Figure 7.png', dpi=300)