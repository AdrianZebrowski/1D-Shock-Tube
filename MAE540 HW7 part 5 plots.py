...
fig1.suptitle("Figure 8: Comparison of FVS and FDS methods, Test 1, $Δx = 0.025$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(1,0.318,0.025)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(1,0.25,0.025)
...
axs1[2].plot(x1, p1)
axs1[2].grid()
axs1[3].plot(x1, e1,label="Van Leer + MUSCL")
axs1[3].grid()
...
axs1[3].plot(x2, e2,'-.',label="Roe + MUSCL")
...
fig1.savefig('HW7 Figure 8.png', dpi=300)

##########

### PART 2
fig2, axs1 = plt.subplots(4,figsize=(6,8))
fig2.suptitle("Figure 9: Comparison of FVS and FDS methods, Test 1, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(1,0.318,0.0125)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(1,0.25,0.0125)
...
fig2.savefig('HW7 Figure 9.png', dpi=300)
...
for i, dx in enumerate(dx_array):     
    ...
    [rho1,u1,p1,e1,x1] = vanleer1DMUSCL(1,0.318,dx)
    [rho2,u2,p2,e2,x2] = roe1DMUSCL(1,0.25,dx)
...
fig3.suptitle("Figure 10: Comparison of L2 error norms, Test 1",fontsize=10)

axs4[0].loglog(1/dx_array,first_order[0,:],"k")
axs4[1].loglog(1/dx_array,first_order[1,:],"k")
axs4[2].loglog(1/dx_array,first_order[2,:],"k")
axs4[3].loglog(1/dx_array,first_order[3,:],"k",label="$O(Δx)$")
...
axs4[3].loglog(1/dx_array,second_order[3,:],"--k",label="$O(Δx^2)$")
...
axs4[2].grid()
axs4[3].loglog(1/dx_array,L2e[0,:],"o",label="Van Leer + MUSCL")
axs4[3].grid()
...
axs4[3].loglog(1/dx_array,L2e[1,:],"^",label="Roe + MUSCL")
axs4[3].set(xlabel="$log(1/Δx)$",ylabel="$log(\epsilon)$, $e$")
axs4[3].legend(loc='upper center', bbox_to_anchor=(0.5,-0.35),ncol=4)
axs4[3].set_xlim([9, 1e3])
fig3.subplots_adjust(top=0.95)
fig3.savefig('HW7 Figure 10.png', dpi=300)
...
fig4.suptitle("Figure 11: Comparison of FVS and FDS methods, Test 2, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(2,0.318,0.0125)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(2,0.25,0.0125)
...
axs5[2].plot(x1, p1)
axs5[2].grid()
axs5[3].plot(x1, e1,label="Van Leer + MUSCL")
axs5[3].grid()
...
axs5[2].set_xlim([0, 1])
axs5[3].plot(x2, e2,'-.',label="Roe + MUSCL")
...
fig4.savefig('HW7 Figure 11.png', dpi=300)
...
fig5.suptitle("Figure 12: Comparison of FVS and FDS methods, Test 3, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(3,0.318,0.0125)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(3,0.25,0.0125)
...
fig5.savefig('HW7 Figure 12.png', dpi=300)
...
fig6.suptitle("Figure 13: Comparison of FVS and FDS methods, Test 4, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(4,0.318,0.0125)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(4,0.25,0.0125)
...
fig6.savefig('HW7 Figure 13.png', dpi=300)
...
fig7.suptitle("Figure 14: Comparison of FVS and FDS methods, Test 5, $Δx = 0.0125$",fontsize=10)

[rho1,u1,p1,e1,x1] = vanleer1DMUSCL(5,0.318,0.0125)
[rho2,u2,p2,e2,x2] = roe1DMUSCL(5,0.25,0.0125)
...
fig7.savefig('HW7 Figure 14.png', dpi=300)